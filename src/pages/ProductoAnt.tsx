                ...
                <div className="lg:col-span-3">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        <div className="grid grid-cols-2 border border-gray-300 p-4 rounded-lg">
                            ...
                            <div><h2 className="font-semibold text-lg">{formatNumber(parseFloat(dataGastos?.producto.costoSt))}</h2></div>
                        </div>

                        <div className="grid grid-cols-2 border border-gray-300 p-4 rounded-lg">
                            <div><h2 className="font-semibold text-lg">Total Gastos</h2></div>
                            <div><h2 className="font-semibold text-lg">{formatNumber(parseFloat(totalGastosRounded))}</h2></div>
                        </div>

                        <div className="grid grid-cols-2 border border-gray-300 p-4 rounded-lg">
                            <div><h2 className="font-semibold text-lg">Costo Total Producto</h2></div>
                            <div><h2 className="font-semibold text-lg">{formatNumber(parseFloat(sumatotal))}</h2></div>
                        </div>
                    </div>

                    <div className="mt-4">
                        <Tabs defaultValue={hash} className="">
